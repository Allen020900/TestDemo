...
public class ProEmp implements ActionListener
{
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		try
		{
			if(e.getSource()==b1)
			{
				...
				String sql = "insert into ProjectEmp values(\'"+t0.getText()+"\',"+t1.getText()+",\'"+t2.getText()+"\',\'"+t3.getText()+"\')";
			...
			if(e.getSource()==b2)
			{
				Class.forName("oracle.jdbc.driver.OracleDriver");
				con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","Allen","Allen0209");
				String sql = "delete from ProjectEmp where Emp_Id = "+t1.getText()+"";
				ps=con.prepareStatement(sql);
				rs=ps.executeQuery();
			}
		}
